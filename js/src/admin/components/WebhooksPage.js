...
export default class WebhooksPage extends ExtensionPage {
  oninit(vnode) {
    ...
    this.services = app.data['fof-webhooks.services'].reduce((o, service) => {
      o[service] = app.translator.trans(
        `fof-webhooks.admin.settings.services.${service}`
      )
      return o
    }, {})
        ...
        <div className="container">
          <div className="Form-group">
            {this.buildSettingComponent({
              ...
              label: app.translator.trans(
                'fof-webhooks.admin.settings.debug_label'
              ),
              help: app.translator.trans(
                'fof-webhooks.admin.settings.debug_help'
              ),
          ...
          <form>
            <p className="helpText">
              {app.translator.trans('fof-webhooks.admin.settings.help.general')}
            </p>
            <fieldset>
                  ...
                  <div className="Webhook-input">
                    ...
                    <input
                      ...
                      placeholder={app.translator.trans(
                        'fof-webhooks.admin.settings.help.url'
                      )}
  ...
  changed() {
    return this.fields.some(
      (key) =>
        this.values[key]() !== (app.data.settings[this.addPrefix(key)] || '')
    )
  }
